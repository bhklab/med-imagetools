...
class TestComponents:
    ...
    def _get_path(self, dataset_path) -> None:  # dataset_path is a fixture defined in conftest.py
    ...
    def test_pipeline(self, modalities) -> None:
        ...
        for subject_id in subject_id_list:
            ...
            for col in output_streams:
                if 'RTSTRUCT' in col:
                    filename = ast.literal_eval(comp_table.loc[subject_id]['metadata_RTSTRUCT_CT'])[
                        0
                    ][0]
                else:
                    filename = col
