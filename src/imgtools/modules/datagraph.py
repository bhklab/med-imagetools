...
class DataGraph:
    ...
    def form_graph(self) -> None:
        ...
        df_filter.loc[
            (df_filter.reference_rs_x.isna()) & (~df_filter.reference_rs_y.isna()), 'reference_rs_x'
        ] = df_filter.loc[
        ...
        df_filter.rename(
            columns={'reference_rs_x': 'reference_rs', 'instance_uid_x': 'instance_uid'},
            inplace=True,
        )
        ...
        * Oct 11th, 2022: Reverted to studyID-based loop + improved readability and make CT,RTSTRUCT,RTDOSE mode pass tests
        ...
        for _, study in enumerate(rel_studyids):
            ...
            rest_locs = df_temp.loc[
                ...
                ['series_x', 'modality_x', 'folder_x', 'series_y', 'modality_y', 'folder_y'],
            ]
